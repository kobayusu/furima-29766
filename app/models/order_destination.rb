class OrderDestination
  ...
  def save
    ...
    # 配送先の情報を保存
    Destination.create(post_number: post_number, prefecture_id: prefecture_id, city: city, address: address, building: building, phone_number: phone_number, order_id: order.id)
  end
end
